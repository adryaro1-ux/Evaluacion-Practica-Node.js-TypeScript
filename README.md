...
**1. Ejercicio 1**: Implementación de un servidor HTTP nativo en Node.js que intercepta peticiones POST, procesa datos de un formulario y sirve dos vistas HTML diferenciadas.
